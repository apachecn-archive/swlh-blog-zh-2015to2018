...
事情是这样的，我毕业后涉足金融实际上是因为*我有机会加入高盛，尽管我的学位是工业&系统工程。*
...
接下来，我学习了 JavaScript 的基础知识，并开始了一个副业项目，将我在过去两周学到的一切融入到上下文中。又过了一周，我完成了我的第一个前端编码项目[的工作(但不完整)版本。](http://iam-peekay.github.io/SAAS-PROJECT/)

现在回过头来看，这个产品看起来很粗糙，很难维护和更新，代码也令人尴尬。我认识到，如果我今天从头开始重新构建它，它可以被写得更加模块化、可维护和更好地结构化(我确实计划将它作为我的一个周末项目来重写)。然而，重点不在于*我在那一周内造了什么*，甚至不在于*我造得有多好*。重点是*实际上使用代码做一些东西*。
...
![](img/ee61e2a02385cc0cf2ba56fc19939f14.png)

【http://www.eoslifework.co.uk/transprac.htm】来源:[](http://www.eoslifework.co.uk/transprac.htm)
